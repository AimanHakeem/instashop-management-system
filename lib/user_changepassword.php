...
if ((isset($opassword))) {
	...
	if ($num) {
		if ((isset($npassword))) {
			...
			if ($num) {
				header('location:../user/accountsetting.php?pass=1');
			}
			else{

				header('location:../user/accountsetting.php?pass=2');
			}
		}
		else{
			echo '<meta http-equiv="refresh" content="0; ../user/accountsetting.php?stat=1>';
		}
	}
	else{
		 header('location:../user/accountsetting.php?pass=3');
	}
}
