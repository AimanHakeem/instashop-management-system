...
if($num){
	...
	echo '<table style="width: 900px;" id="example" class="table table-striped"id="mysdata" >';
	echo '<thead>';
	echo '<th>No.</th><th>Username</th><th>Instagram</th><th>Email</th><th>SSM No.</th><th>Service Provided</th><th>Address</th><th>City</th><th>Postcode</th><th>State</th><th>Status</th><th>View Profile</th></thead><tbody>';
	$n=1;
	while($row = $sqlst->fetch(PDO::FETCH_ASSOC)){
		...
		echo '<td><a class="btn btn-warning" role="button" href="viewprofile.php?id='.$row['id_user'].'"><i class="fa fa-user"></i> View Profile</a></td>';
		$n++;
	}
	echo '</tbody></table>';
	echo '</div>';
