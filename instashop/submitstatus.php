        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            if($num){
              ...
              $status = $row['status'];
              if ($status == '1') {
                echo 'Your submission is in process, please wait for admin approval. Thank you!';
              }
              elseif ($status == '2') {
                echo 'You had gained Trusted Status for Instashop!';
              }
              elseif ($status == '3'){
                ?>
              <div class="col-md-6">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <p><strong>Something is not right about your recent applicaton. You are allowed to reapply for new application to gained trusted status of your account.</strong></p>
            </div>
          </div>
        </div>
                <form method="post" action="../lib/submit_status.php" enctype="multipart/form-data" style="width:500px;">
                  ...
                  <div class="input-group">
                    ...
                    if($num){
                      $row = $sqlst->fetch(PDO::FETCH_ASSOC);
                      echo '<input type="text" class="form-control" disabled="" value="'.$row['instagram'].'" aria-describedby="basic-addon1">';
                    }
                    ?>
                  </div>
                  <br/>
                  <div class="input-group">
                    ...
                    if($num){
                      $row = $sqlst->fetch(PDO::FETCH_ASSOC);
                      echo '<input type="text" class="form-control" disabled="" value="'.$row['service_provided'].'" aria-describedby="basic-addon1">';
                    }
                    ?>
                  </div>
                  <br/>
                  <div class="input-group">
                    ...
                    if($num){
                      $row = $sqlst->fetch(PDO::FETCH_ASSOC);
                      echo '<input type="text" class="form-control" disabled="" value="'.$row['email'].'" aria-describedby="basic-addon1">';
                    }
                    ?>
                  </div>
                  <br/>
                  <div class="input-group">
                    ...
                    if($num){
                      $row = $sqlst->fetch(PDO::FETCH_ASSOC);
                      echo '<input type="text" class="form-control" disabled="" value="'.$row['ssm_no'].'"   aria-describedby="basic-addon1">';
                    }
                    ?>
                  </div>
                  <br/>
                  <div class="input-group">
                    ...
                    <span class="input-group-addon" id="basic-addon1">Upload SSM document</span>
